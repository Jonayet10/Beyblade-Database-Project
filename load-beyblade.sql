...
LOAD DATA LOCAL INFILE 'parts.csv' INTO TABLE albums
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 ROWS;

-- Load the data for beyblades table
LOAD DATA LOCAL INFILE 'beyblades.csv' INTO TABLE playlists
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 ROWS;

-- Load the data for userbeyblades table
LOAD DATA LOCAL INFILE 'userbeyblades.csv' INTO TABLE tracks
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 ROWS;

-- Load the data for battles table
LOAD DATA LOCAL INFILE 'battles.csv' INTO TABLE tracks
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 ROWS;
